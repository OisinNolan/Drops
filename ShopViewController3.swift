...
class ShopViewController3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        isBought1 = NSUserDefaults.standardUserDefaults().boolForKey("isBought13")
        isBought2 = NSUserDefaults.standardUserDefaults().boolForKey("isBought23")
        isBought3 = NSUserDefaults.standardUserDefaults().boolForKey("isBought33")
        isBought4 = NSUserDefaults.standardUserDefaults().boolForKey("isBought43")
        isBought5 = NSUserDefaults.standardUserDefaults().boolForKey("isBought53")
        isBought6 = NSUserDefaults.standardUserDefaults().boolForKey("isBought63")
        
        isSelected1 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected13")
        isSelected2 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected23")
        isSelected3 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected33")
        isSelected4 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected43")
        isSelected5 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected53")
        isSelected6 = NSUserDefaults.standardUserDefaults().boolForKey("isSelected63")
        
        coinAmount = NSUserDefaults.standardUserDefaults().integerForKey("coinAmount13")
    ...
    var counter1 = NSUserDefaults.standardUserDefaults().integerForKey("counter13")
    var counter2 = NSUserDefaults.standardUserDefaults().integerForKey("counter23")
    var counter3 = NSUserDefaults.standardUserDefaults().integerForKey("counter33")
    var counter4 = NSUserDefaults.standardUserDefaults().integerForKey("counter43")
    var counter5 = NSUserDefaults.standardUserDefaults().integerForKey("counter53")
    var counter6 = NSUserDefaults.standardUserDefaults().integerForKey("counter63")
    ...
    @IBAction func theme1Action(sender: AnyObject) {
        ...
        counter1++
        NSUserDefaults.standardUserDefaults().setInteger(counter1, forKey: "counter13")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter1 % 2 == 0 {
            ...
            if isBought1 && shopVC.oneSelected {
                if isSelected1{
                    //deselect
                    isSelected1 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected1, forKey: "isSelected13")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought1 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().setInteger(coinAmount, forKey: "coinAmount13")
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought1 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought1, forKey: "isBought13")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme1Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme1Button)
            }
    ...
    @IBAction func theme2Action(sender: AnyObject) {
        ...
        counter2++
        NSUserDefaults.standardUserDefaults().setInteger(counter2, forKey: "counter23")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter2 % 2 == 0 {
            ...
            if isBought2 && shopVC.oneSelected {
                if isSelected2 {
                    //deselect
                    isSelected2 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected2, forKey: "isSelected23")
                    NSUserDefaults.standardUserDefaults().synchronize()
                    shopVC.oneSelected = false
                    NSUserDefaults.standardUserDefaults().setBool(shopVC.oneSelected, forKey: "oneSelected")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought2 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought2 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought2, forKey: "isBought23")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme2Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme2Button)
            }
    ...
    @IBAction func theme3Action(sender: AnyObject) {
        ...
        counter3++
        NSUserDefaults.standardUserDefaults().setInteger(counter3, forKey: "counter33")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter3 % 2 == 0 {
            ...
            if isBought3 && shopVC.oneSelected {
                if isSelected3 {
                    //deselect
                    isSelected3 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected3, forKey: "isSelected33")
                    NSUserDefaults.standardUserDefaults().synchronize()
                    shopVC.oneSelected = false
                    NSUserDefaults.standardUserDefaults().setBool(shopVC.oneSelected, forKey: "oneSelected")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought3 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought3 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought3, forKey: "isBought33")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme3Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme3Button)
            }
    ...
    @IBAction func theme4Action(sender: AnyObject) {
        ...
        counter4++
        NSUserDefaults.standardUserDefaults().setInteger(counter4, forKey: "counter43")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter4 % 2 == 0 {
            ...
            if isBought4 && shopVC.oneSelected {
                if isSelected4 {
                    //deselect
                    isSelected4 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected4, forKey: "isSelected43")
                    NSUserDefaults.standardUserDefaults().synchronize()
                    shopVC.oneSelected = false
                    NSUserDefaults.standardUserDefaults().setBool(shopVC.oneSelected, forKey: "oneSelected")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought4 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought4 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought4, forKey: "isBought43")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme4Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme4Button)
            }
    ...
    @IBAction func theme5Action(sender: AnyObject) {
        ...
        counter5++
        NSUserDefaults.standardUserDefaults().setInteger(counter5, forKey: "counter53")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter5 % 2 == 0 {
            ...
            if isBought5 && shopVC.oneSelected {
                if isSelected5 {
                    //deselect
                    isSelected5 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected5, forKey: "isSelected53")
                    NSUserDefaults.standardUserDefaults().synchronize()
                    shopVC.oneSelected = false
                    NSUserDefaults.standardUserDefaults().setBool(shopVC.oneSelected, forKey: "oneSelected")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought5 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought5 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought5, forKey: "isBought53")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme5Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme5Button)
            }
    ...
    @IBAction func theme6Action(sender: AnyObject) {
        ...
        counter6++
        NSUserDefaults.standardUserDefaults().setInteger(counter6, forKey: "counter63")
        NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if counter6 % 2 == 0 {
            ...
            if isBought6 && shopVC.oneSelected {
                if isSelected6 {
                    //deselect
                    isSelected6 = false
                    NSUserDefaults.standardUserDefaults().setBool(isSelected6, forKey: "isSelected63")
                    NSUserDefaults.standardUserDefaults().synchronize()
                    shopVC.oneSelected = false
                    NSUserDefaults.standardUserDefaults().setBool(shopVC.oneSelected, forKey: "oneSelected")
                    NSUserDefaults.standardUserDefaults().synchronize()
        ...
        if !isBought6 {
            ...
            if coinAmount >= price {
                ...
                NSUserDefaults.standardUserDefaults().synchronize()
                isBought6 = true
                NSUserDefaults.standardUserDefaults().setBool(isBought6, forKey: "isBought63")
                NSUserDefaults.standardUserDefaults().synchronize()
                theme6Button.setTitle("SELECT", forState: .Normal)
                turnPinkButton(theme6Button)
            }
